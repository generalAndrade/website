...
?>
				...
				<div class="post-single">
					...
					<ul class="post-info list-inline">
						<li><a href="<?php echo esc_url(get_day_link(get_post_time('Y'), get_post_time('m'), get_post_time('d'))); ?>" title=""><i class="fa fa-calendar"></i> <?php echo esc_attr(get_the_date('d M Y'));?></a></li>
